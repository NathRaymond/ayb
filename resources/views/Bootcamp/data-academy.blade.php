            ...
            <div class="col-lg-12">
                <div class="breadcrumb_iner text-center">
                    <div class="breadcrumb_iner_item text-center py-5 rounded-4 shadow-sm">
                        <h2 class="fw-bold display-6 mb-3 text-white">AI, Data Science & Machine Learning Training</h2>
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body p-5">
                        <div class="text-center mb-5">
                            <img src="{{ asset('img/bootcamp_img.jpg') }}" alt="Data Academy Flyer" class="img-fluid rounded-3" style="max-width: 70%; height: auto;">
                        </div>
                        <h1 class="mb-5 text-center display-5 fw-bold">Register for Data Academy Training</h1>
                        <form action="{{ route('form.store.DataAcademyAfrica') }}" method="POST" style="font-size: 1.1rem;" onsubmit="showloader6()">
                            @csrf
                            <div class="mb-4">
